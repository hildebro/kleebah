...
- [x] Editing/deleting existing blogs
- [x] Blog viewer
- [x] RSS feed
- [x] Image upload
...
- [x] (Temporary) self-registration link that can be generated by admin
- [x] Role-management
  ...
  - [x] Option on private blog entries to define required roles
  - [x] Update RSS feed to consider roles
